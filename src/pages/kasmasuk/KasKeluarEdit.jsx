...
class KasKeluarEdit extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = (e) => {
        ...
        Swal.fire({
            title: 'Simpan data?',
            text: "Anda yakin akan menyimpan data rincian pengeluaran kas ini?",
            icon: 'warning',
            ...
            if (result.value) {
                Axios.post(this.props.API + "pengeluarankas/addrincian", 
                    {
                        id: this.state.id,
    ...
    rincianList = () => {
        this.setState({rincianListLoading: true}, () => {
            Axios.get(this.props.API + "pengeluarankas/rincianlist/" + this.state.id_penerimaan_kas,
                {
                    headers: {
                        Authorization: "Bearer " + this.props.token.user_token
                    }
    ...
    rincianEdit = (id) => {
        Axios.get(this.props.API + "pengeluarankas/findrincian/" + id,
                    {
                        headers: {
                            Authorization: "Bearer " + this.props.token.user_token
                        }
    ...
    rincianDelete = (id) => {
        Swal.fire({
            title: 'Hapus data?',
            text: "Anda yakin akan menghapus data rincian pengeluaran kas ini?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                Axios.get(this.props.API + "pengeluarankas/deleterincian/" + id,
                    {
                        headers: {
                            Authorization: "Bearer " + this.props.token.user_token
                        }
    ...
    handleSubmitHeader = (e) => {
        ...
        Swal.fire({
            title: 'Simpan data?',
            text: "Anda yakin akan menyimpan data pengeluaran kas ini?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                Axios.post(this.props.API + "pengeluarankas/addheader",
                    {
                        id_pengeluaran_kas: this.state.id_penerimaan_kas,
    ...
    findHeader = () => {
        Axios.get(this.props.API + "pengeluarankas/findheader/" + this.state.id_penerimaan_kas,
            {
                headers: {
                    Authorization: "Bearer " + this.props.token.user_token
                }
            ...
            .then((r) => {
                var data = r.data;
                this.setState({
                    id_akun_debet: data.id_akun_kredit,
    ...
    render() {
        ...
        return (
            <div>
                <PageHeading
                    fa_icon="fa fa-file" judul_besar="Ubah Pengeluaran Kas"
                    judul_kecil="Menu penerimaan kas untuk mencatat pengurangan saldo akun-akun kas dan setara kas"></PageHeading>

                <div className="row">
                    <div className="col-sm-6">
                        <Panel header="Rincian Pengeluaran Kas">
                            <form onSubmit={this.handleSubmit} onReset={this.handleReset}>
                                <div className="row">
                                    <CtrlTextCOAWithCol col="12" label="Akun Debet" id="txtAkunKredit" handle={this.handleAkunKredit} nilai={this.state.id_akun_kredit} />
                                </div>
                                <div className="row">
                        ...
                        <Panel header="Keterangan Pengeluaran Kas">
                            <form onSubmit={this.handleSubmitHeader}>
                                <div className="row">
                                    <CtrlTextCOAWithCol col="12" label="Akun Kredit (Kas dan Setara Kas)" id="txtAkunDebet" handle={this.handleAkunDebet} nilai={this.state.id_akun_debet} />
                                </div>
                                <div className="row">
                    ...
                    <div className="col-sm-6">
                        <Panel header="Daftar Rincian Pengeluaran Kas" footer={"Total : " + accounting.formatNumber(this.state.totalRincian)}>
                            {
...
export default connect(mapStateToProps)(KasKeluarEdit);