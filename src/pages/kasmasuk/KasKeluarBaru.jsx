...
class KasKeluarBaru extends Component {
    constructor(props) {
        super(props);
    ...
    rincianList = () => {
        this.setState({rincianListLoading: true}, () => {
            Axios.get(this.props.API + "pengeluarankas/rincianlist/0",
                {
                    headers: {
                        Authorization: "Bearer " + this.props.token.user_token
                    }
        ...
        return (
            <div>
                <PageHeading
                    ...
                    judul_kecil="Menu pengeluaran kas untuk mencatat pengurangan saldo akun-akun kas dan setara kas"></PageHeading>
...
export default connect(mapStateToProps)(KasKeluarBaru);