...
class KasMasukList extends Component {
    constructor(props) {
        super(props);
    ...
    loadList = () => {
        this.setState({listLoading: true}, () => {
            Axios.get(this.props.API + "penerimaankas/headerlist",
                {
                    params: {
    ...
    rincianDelete = (id) => {
        Swal.fire({
            ...
            if(result.value) {
                Axios.get(this.props.API + "penerimaankas/deleteheader/" + id)
                    .then((r) => {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
    ...
    render() {
        ...
        return (
            <div>
                <PageHeading
                    fa_icon="fa fa-file" judul_besar="Penerimaan Kas"
                ...
                <ListNavigation history={this.props.history} add="/kasmasukadd" />
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        <Panel header="Daftar Penerimaan Kas">
                            {
...
export default connect(mapStateToProps)(KasMasukList);