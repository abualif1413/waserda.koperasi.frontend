...
class KasMasukBaru extends Component {
    constructor(props) {
        super(props);
    ...
    rincianList = () => {
        this.setState({rincianListLoading: true}, () => {
            Axios.get(this.props.API + "penerimaankas/rincianlist/0",
                {
                    headers: {
                        Authorization: "Bearer " + this.props.token.user_token
                    }
                ...
                .finally((f) => {
                    this.setState({rincianListLoading: false});
                });
        })
    }
...
export default connect(mapStateToProps)(KasMasukBaru);