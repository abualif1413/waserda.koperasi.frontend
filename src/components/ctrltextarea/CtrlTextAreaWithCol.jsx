...
class CtrlTextAreaWithCol extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentWillReceiveProps = (props) => {
        if(props.nilai) {
            this.setState({nilai: props.nilai});
        } else {
            this.setState({nilai: ""});
        }
    }
    ...
    render = () => {
        ...
        return (
            <div className={"col-sm-" + this.props.col}>
                <div className="ctrltextarea form-group">
...
export default CtrlTextAreaWithCol;